...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Заказ с YouDo — Универмаг премиальной одежды" },
      {
        name: "description",
        content:
          "Премиальная одежда, обувь и аксессуары с доставкой СДЭК по всей России. Тщательный отбор коллекций, безопасная онлайн-оплата.",
      },
      { name: "author", content: "Заказ с YouDo" },
      { property: "og:title", content: "Заказ с YouDo — Универмаг премиальной одежды" },
      { property: "og:description", content: "Премиальная одежда, обувь и аксессуары с доставкой СДЭК по всей России. Тщательный отбор коллекций, безопасная онлайн-оплата." },
